...
echo "<div class=\"text-muted\" style=\"font-size:11px;\">Rp. ".Rp($p['besar_pinjam'])."</div>";
?>
 ...
 <div class="row-fluid">
  ...
  <i class="glyphicon glyphicon-th"></i> Pinjaman yang belum Lunas
   ...
   <div class="notif2">
  	...
  	<div class="row no-padding">
						<div class="col-sm-3 widget-left-simpanan" style="height: 220px;">
						<i class="glyph fa fa-calendar" style="font-size:30px;margin-top: 80px;"></i>
						</div>
						<div class="col-sm-9 widget-right-simpanan">
							<div class="standard">Data Pinjaman</div>
							


<?php
foreach($eksternal->result() as $e){
echo "<div class=\"text-bulan\">Periode Bulan :  ".bulanan($bulanan)."</div><hr>";	
...
<a class="btn btn-info btn-sm" href="<?php echo site_url('pinjaman/add'); ?>"><i class="glyphicon glyphicon-plus"></i> Buat Pengajuan Baru</a>
	  ...
	  <div class="panel panel-teal panel-widget">
  	<div class="row no-padding">
						<div class="col-sm-3 widget-left-simpanan" style="height: 170px;">
						<i class="glyph fa fa-dollar" style="font-size:30px;margin-top: 60px;"></i>
						</div>
						<div class="col-sm-9 widget-right-simpanan" >
							<div class="standard">Pendapatan </div>
							
						
							
<?php
foreach($kasbulanan->result() as $e){
echo "<div class=\"text-bulan\">Periode Bulan :  ".bulanan($bulanan)."</div></br>";	
echo "<div class=\"text-muted\">Total  :  Rp. ".Rp($e->nilai)."</br>";

}
?>	<a class="btn btn-warning btn-xs" href="<?php echo site_url('pendapatan'); ?>"><i class="glyphicon glyphicon-search"></i> Detail</a></div>
<hr class='hr5'>	

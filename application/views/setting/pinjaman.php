...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-cube fa-fw'></i> Pinjaman </h5>
			<hr />
...
{
	$tambahan .= nbs(2)."<a href='".site_url('setting/tambah-pinjaman')."' class='btn btn-sm btn-default' id='TambahHalaman'><i class='fa fa-plus fa-fw'></i> Tambah Jenis Pinjaman</a>";
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('setting/pinjaman-json'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");
	...
	$(document).on('click', '#TambahHalaman, #EditPinjaman', function(e){
		...
		{
			$('#ModalHeader').html('Tambah Jenis Pinjaman');
		}
		if($(this).attr('id') == 'EditPinjaman')
		{
			$('#ModalHeader').html('Edit Halaman');
		}

...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<hr />
<div class="well"><i class='fa fa-info fa-fw'></i> Halaman Angusan Pinjaman Non Anggota yang sudah lunas</div>
...
{
	$tambahan .= nbs(2)."<a href='".site_url('angsuran')."' class='btn btn-sm btn-danger' id=''><i class='fa fa-share fa-fw'></i> Data Angsuran yang belum Lunas</a>";
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('angsuran/list-angsuran-lunas-json'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");

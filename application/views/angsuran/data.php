...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-share fa-fw'></i> Transaksi Angsuran </h5>
			<hr />
...
{
	$tambahan .= nbs(2)."<a href='".site_url('angsuran')."' class='btn btn-xs btn-warning' id=''><i class='fa fa-share fa-fw'></i> Data Angsuran Anggota</a>";
	$tambahan .= nbs(2)."<a href='".site_url('angsuran/external')."' class='btn btn-xs btn-info' id=''><i class='fa fa-share fa-fw'></i> Data Angsuran External</a>";
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('angsuran/angsuran-json'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");

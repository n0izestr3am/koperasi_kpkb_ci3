...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-file-text-o fa-fw'></i> Laporan Transaksi - <?php echo config_item('web_title'); ?> </h5>
			<hr />
				...
				<div class="col-sm-5">
					<div class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<button type="submit" class="btn btn-danger" style='margin-left: 0px;'>Tampilkan</button>
							</div>
						</div>
					</div>
				</div>

...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-users fa-fw'></i> Pengajuan Pinjaman Non Anggota </h5>
			<hr />
...
{
$tambahan .= nbs(2)."<a href='".site_url('pinjaman/ajukan')."' class='btn btn-xs btn-danger' id='TambahBahan'><i class='fa fa-plus fa-fw'></i> Buat Pengajuan Pinjaman Baru </a>";
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('pengajuan/list-external-json'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");

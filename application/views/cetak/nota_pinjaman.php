                     ...
                     <div class="area" style="overflow: hidden;">
                        ...
                        <div style="margin-top: 10px;">
                            <table class="new_grid">
                                <tr>
			  <td style="background:#000000; color:#FFFFFF; width: 25px;">No</td>
              <td style="background:#000000;  color:#FFFFFF;text-align:center; width: 200px;">Besar Pinjaman</td>
              <td style="background:#000000; color:#FFFFFF; text-align:center; width: 100px;">Angsuran / Bulan</td>
              <td style="background:#000000;  color:#FFFFFF;text-align:center; width: 100px;">Bunga / Bulan</td>
              <td style="background:#000000; color:#FFFFFF; text-align:center; width: 150px;">Angsuran Pokok</td>

...
<table class="info_pelanggan" width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    ...
    <td align="right" width="30%">
        ...
        <div class="judul-header">NOTA REGISTRASI ANGGOTA</div>
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td align="left">
        <div class="judul">Nama : <?php echo "".$master->nama."";?></div>
...
<div class="tgl"><?php echo tanggal($tanggal) ;?></div>
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
 ...
 <td align="left"  width="73%">
    ...
    <td >
		...
		<?php
		$sub_total 	= $master->per_total;
		$grand_total 	= $admin+$ik+$dk+$kta+$sub_total;
		echo "<table class='info_pelanggan'>
			<tr>
				<td style='width:100%;'>Administrasi</td>
				<td>:</td>
				<td>Rp. ".Rp($admin)."</td>
			</tr>
			<tr>
				<td style='width:100%;'>Dana Kecelakaan</td>
				<td>:</td>
				<td>Rp. ".Rp($dk)."</td>
			</tr>
			<tr>
			...
			<td>Rp. ".Rp($kta)."</td>
				...
				<tr>
				<td style='background:#009141; color:#FFFFFF;'>T O T A L</td>
				<td style='background:#FFFFFF; color:#000;'>:</td>
			<td style='background:#FFFFFF; color:#000;'>Rp. ".Rp($grand_total)."</td>
			</tr>
		</table>";?>

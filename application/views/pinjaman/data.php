...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-users fa-fw'></i> Transaksi External </h5>
			<hr />
...
{
	$tambahan .= nbs(2)."<a href='".site_url('transaksi/tambah-external')."' class='btn btn-sm btn-default' id='TambahBahan'><i class='fa fa-plus fa-fw'></i> Tambah Transaksi External</a>";
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('transaksi/list-external-json'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");
	...
	$(document).on('click', '#TambahBahan, #EditBahan', function(e){
		e.preventDefault();

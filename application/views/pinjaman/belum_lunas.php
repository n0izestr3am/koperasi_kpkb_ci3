...
{
	$tambahan .= nbs(2)."<a href='".site_url('pinjaman/lunas')."' class='btn btn-xs btn-primary' id=''><i class='fa fa-plus fa-fw'></i> Pinjaman Lunas </a>";
	$tambahan .= nbs(2)."<a href='".site_url('pinjaman/belum-lunas')."' class='btn btn-xs btn-default' id=''><i class='fa fa-plus fa-fw'></i> Pinjaman Belum Lunas </a>";
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('pinjaman/list-pinjaman-belum-lunas-json'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");

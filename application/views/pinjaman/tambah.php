...
$pn = $this->db->query("SELECT * FROM pengajuan where status='belum acc' and kode_anggota='$kode' order by kode_pengajuan desc");
...
$p = $this->db->query("SELECT * FROM pengajuan where kode_anggota='$kode'");
$ajuan = $p->num_rows();
if($df==null)
        {
...
<script type="text/javascript" language="javascript" >
 	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('angsuran/list-angsuran-json/'.$kode.''); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");

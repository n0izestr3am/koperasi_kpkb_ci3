...
<html lang="en">
	<head>
		...
		<link href="<?php echo config_item('bootstrap'); ?>css/bootstrap.css" rel="stylesheet">
		...
		<script src="<?php echo config_item('js'); ?>lumino.glyphs.js"></script>
		<link href="<?php echo config_item('plugin'); ?>morris/css/morris.css" rel="stylesheet">
		<script>
		var habiscuy;
		$(document).on({
			ajaxStart: function() { 

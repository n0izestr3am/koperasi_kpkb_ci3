...
$config['monika']			= $config['base_url'].'assets/monika/';
$config['css'] 				= $config['assets'].'css/';
$config['fonts'] 			= $config['assets'].'css/fonts/';
...
$config['web_title']		= "Koperasi Pemerintah Kota Bandung";
$config['web_footer']		= $config['web_title']." &copy; ".date('Y').". Version 1.0. Sistem Informasi -  KPKBs ";
